...
const WeatherCard = () => {
  ...
  const fetchWeatherData = useCallback(async () => {
    ...
    const currentWeatherURL = `https://api.openweathermap.org/data/2.5/weather?q=${debouncedCity}&appid=${API_KEY}&units=metric`;
    const forecastURL = `https://api.openweathermap.org/data/2.5/forecast?q=${debouncedCity}&appid=${API_KEY}&units=metric`;
